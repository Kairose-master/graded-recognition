...
net change of \(F\) (fixes − breaks) {[}CI{]} & +0.135 {[}0.085, 0.190{]} & \textbf{+0.155 {[}0.110, 0.210{]}} & 0 \\
net change of \(C\) {[}CI{]} & −0.090 {[}−0.140, −0.040{]} & \textbf{−0.070 {[}−0.120, −0.020{]}} & 0 \\
...
Table 6. The \(k\)-round symbolic reasoner and the four-round learned reasoner on the same table; accuracy is over all four queries.
...
Table 7. The composition test for the four-round model by query; the symbolic reasoner agrees at 1.000 on every pair and the two-round model at 0.975 or above on every primary pair.
